...
def run_data_research(file_path):
    ...
    df_long = pd.melt(df, id_vars=meta_cols, value_vars=day_cols, 
    ...
    kyiv_data = df_long[(df_long['city'] == 'Київ') & 
                        (df_long['nameImpurity'] == 'Завислі речовини')].sort_values('day')
    ...
    stability_analysis['variability_%'] = (stability_analysis['std'] / stability_analysis['mean']) * 100
...
if __name__ == "__main__":
    df_transformed = run_data_research('shchodenni-za-sichen-2026.csv')
